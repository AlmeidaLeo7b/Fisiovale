export default function Footer() {
    return (
      // Fundo branco com uma borda superior sutil para separar do conteúdo anterior
      <footer className="bg-white py-20 px-6 border-t border-gray-100">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
          ...
          <div className="flex flex-col items-center">
            <h3 className="font-libre text-2xl text-[#94a68c] mb-6">
              Localização
            </h3>
            <div className="text-gray-600 leading-relaxed">
              <p>Rua Miracatu, 226</p>
              <p>Vila Tupy, Registro/SP</p>
              <p>CEP 11900-000</p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="text-gray-600 leading-relaxed">
              ...
              <p className="font-medium">Das 08:00 às 18:00</p>
              <br />
            </div>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="text-gray-600 leading-relaxed space-y-2">
              <p>
                <a href="mailto:contato@fisiovale.com.br" className="hover:text-[#94a68c] transition-colors border-b border-gray-300 pb-1">
                  contato@fisiovale.com.br
                </a>
              </p>
              <p>
                <a href="tel:+5513997595418" className="hover:text-[#94a68c] transition-colors">
                    (13) 99759-5418
                </a>
              </p>
              ...
              <div className="flex gap-4 mt-6 justify-center">
                 ...
                 {/* Botão Instagram */}
                 <a 
                   href="https://www.instagram.com/fisiovale_rgt" 
                   target="_blank" 
                 ...
                 {/* Botão WhatsApp */}
                 <a 
                   href="https://wa.me/5513997595418" 
                   target="_blank" 
                   rel="noopener noreferrer"
        ...
        {/* Direitos Autorais (Rodapé do Rodapé) */}
        <div className="text-center text-gray-400 text-sm mt-16 pt-8 border-t border-gray-100">
          &copy; 2025 Clínica Fisiovale. Todos os direitos reservados - Desenvolvido por Leonardo Almeida.
        </div>
